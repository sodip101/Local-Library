...
exports.book_create_get = function(req, res,next) {
    ...
    async.parallel({
        ...
        if(err){return next(err);}
        res.render('book_form',{title:'Add New Book',authors:results.authors,genres:results.genres});
    });
};
    ...
    (req,res,next)=>{
        ...
        if(!errors.isEmpty()){
            ...
            async.parallel({
                ...
                res.render('book_form',{title:'Add New Book',authors:results.authors,genres:results.genres,book:book,error:errors.array()});
            });
            return;
        }else{
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            Book.findByIdAndUpdate(req.params.id, book, {}, function (err,thebook) {
                ...
                res.redirect('/catalog/'+thebook.url);
            });
        }
    }
];